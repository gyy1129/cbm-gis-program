...
;(function (global, factory) {
  ...
  class Coordinate {
    ...
    equals3D(other) {
      return (
        this.x === other.x &&
        this.y === other.y &&
        (this.getZ() === other.getZ() || (Double.isNaN(this.getZ()) && Double.isNaN(other.getZ())))
      )
    }
  ...
  class Envelope {
    ...
    disjoint(other) {
      ...
      return (
        other._minx > this._maxx || other._maxx < this._minx || other._miny > this._maxy || other._maxy < this._miny
      )
    }
  ...
  class DD {
    ...
    static determinant() {
      if (
        ...
        arguments[3] instanceof DD &&
        arguments[2] instanceof DD &&
        arguments[0] instanceof DD &&
        arguments[1] instanceof DD
      ) {
        const x1 = arguments[0],
          y1 = arguments[1],
          x2 = arguments[2],
  ...
  DD.PI = new DD(3.141592653589793116, 1.224646799147353207e-16)
  DD.TWO_PI = new DD(6.283185307179586232, 2.449293598294706414e-16)
  DD.PI_2 = new DD(1.570796326794896558, 6.123233995736766036e-17)
  DD.E = new DD(2.718281828459045091, 1.445646891729250158e-16)
  ...
  class Geometry {
    ...
    isGeometryCollectionOrDerived() {
      if (
        this.getTypeCode() === Geometry.TYPECODE_GEOMETRYCOLLECTION ||
        this.getTypeCode() === Geometry.TYPECODE_MULTIPOINT ||
        this.getTypeCode() === Geometry.TYPECODE_MULTILINESTRING ||
        this.getTypeCode() === Geometry.TYPECODE_MULTIPOLYGON
      )
        return true
      return false
    }
  ...
  class CoordinateSequences {
    ...
    static indexOf(coordinate, seq) {
      for (let i = 0; i < seq.size(); i++)
        if (
          coordinate.x === seq.getOrdinate(i, CoordinateSequence.X) &&
  ...
  class Polygon extends Geometry {
    ...
    equalsExact() {
      if (arguments.length === 2 && typeof arguments[1] === 'number' && arguments[0] instanceof Geometry) {
        ...
        for (let i = 0; i < this._holes.length; i++)
          if (!this._holes[i].equalsExact(otherPolygon._holes[i], tolerance)) return false
  ...
  class GeometryCollection extends Geometry {
    ...
    equalsExact() {
      if (arguments.length === 2 && typeof arguments[1] === 'number' && arguments[0] instanceof Geometry) {
        ...
        for (let i = 0; i < this._geometries.length; i++)
          if (!this._geometries[i].equalsExact(otherCollection._geometries[i], tolerance)) return false
  ...
  class LinearRing extends LineString {
    ...
    validateConstruction() {
      ...
      if (
        ...
        this.getCoordinateSequence().size() < LinearRing.MINIMUM_VALID_SIZE
      )
        throw new IllegalArgumentException(
  ...
  class Coordinates {
    static measures(coordinate) {
      if (coordinate instanceof CoordinateXY) return 0
      else if (coordinate instanceof CoordinateXYM) return 1
      else if (coordinate instanceof CoordinateXYZM) return 1
      else if (coordinate instanceof Coordinate) return 0
      return 0
    }

    static dimension(coordinate) {
      if (coordinate instanceof CoordinateXY) return 2
      else if (coordinate instanceof CoordinateXYM) return 3
      else if (coordinate instanceof CoordinateXYZM) return 4
      else if (coordinate instanceof Coordinate) return 3
      return 3
    }
    ...
    static create() {
      if (arguments.length === 1) {
        ...
        if (dimension === 2) return new CoordinateXY()
        else if (dimension === 3 && measures === 0) return new Coordinate()
        else if (dimension === 3 && measures === 1) return new CoordinateXYM()
        else if (dimension === 4 && measures === 1) return new CoordinateXYZM()
  ...
  class CoordinateArraySequence {
    ...
    static constructor_() {
      ...
      if (arguments.length === 1) {
        if (arguments[0] instanceof Array) {
          const coordinates = arguments[0]
          CoordinateArraySequence.constructor_.call(
            this,
            coordinates,
  ...
  class GeometryFactory {
    ...
    static constructor_() {
      ...
      if (arguments.length === 0) {
        ...
        if (hasInterface(arguments[0], CoordinateSequenceFactory)) {
          ...
          GeometryFactory.constructor_.call(
            this,
            precisionModel,
            0,
    ...
    createLineString() {
      if (arguments.length === 0) return this.createLineString(this.getCoordinateSequenceFactory().create([]))
        ...
        if (arguments[0] instanceof Array) {
          const coordinates = arguments[0]
          return this.createLineString(
            coordinates !== null ? this.getCoordinateSequenceFactory().create(coordinates) : null
          )
        } else if (hasInterface(arguments[0], CoordinateSequence)) {
          const coordinates = arguments[0]
    ...
    buildGeometry(geomList) {
      ...
      if (isCollection) {
        if (geom0 instanceof Polygon) return this.createMultiPolygon(GeometryFactory.toPolygonArray(geomList))
        else if (geom0 instanceof LineString)
          return this.createMultiLineString(GeometryFactory.toLineStringArray(geomList))
        else if (geom0 instanceof Point) return this.createMultiPoint(GeometryFactory.toPointArray(geomList))
    ...
    createMultiPoint() {
      if (arguments.length === 0) return new MultiPoint(null, this)
      else if (arguments.length === 1)
        if (arguments[0] instanceof Array) {
          ...
          for (let i = 0; i < coordinates.size(); i++) {
            const ptSeq = this.getCoordinateSequenceFactory().create(
              1,
  ...
  class Lexer {
    ...
    readNumber_() {
      ...
      do {
        ...
        this.isNumeric_(c, decimal) || // if we haven't detected a scientific number before, 'e' or 'E'
  ...
  class Parser {
    ...
    parseGeometry_() {
      ...
      const ca2p = coordinates => {
        ...
        else return factory.createPolygon(rings[0])
      }
  ...
  class LineIntersector {
    ...
    isInteriorIntersection() {
      if (arguments.length === 0) {
        ...
        for (let i = 0; i < this._result; i++)
          if (
            !(
              this._intPt[i].equals2D(this._inputLines[inputLineIndex][0]) ||
              this._intPt[i].equals2D(this._inputLines[inputLineIndex][1])
            )
          )
            return true
    ...
    getEdgeDistance(segmentIndex, intIndex) {
      const dist = LineIntersector.computeEdgeDistance(
        this._intPt[intIndex],
        this._inputLines[segmentIndex][0],
        this._inputLines[segmentIndex][1]
      )
      return dist
    }
    ...
    toString() {
      return (
        WKTWriter.toLineString(this._inputLines[0][0], this._inputLines[0][1]) +
        ' - ' +
        WKTWriter.toLineString(this._inputLines[1][0], this._inputLines[1][1]) +
  ...
  class RobustLineIntersector extends LineIntersector {
    ...
    computeIntersect(p1, p2, q1, q2) {
      ...
      if (Pq1 === 0 || Pq2 === 0 || Qp1 === 0 || Qp2 === 0) {
        ...
        else if (Pq1 === 0) this._intPt[0] = new Coordinate(q1)
        else if (Pq2 === 0) this._intPt[0] = new Coordinate(q2)
        else if (Qp1 === 0) this._intPt[0] = new Coordinate(p1)
        else if (Qp2 === 0) this._intPt[0] = new Coordinate(p2)
      } else {
        this._isProper = true
  ...
  class LineSegment {
    ...
    equalsTopo(other) {
      return (
        (this.p0.equals(other.p0) && this.p1.equals(other.p1)) || (this.p0.equals(other.p1) && this.p1.equals(other.p0))
      )
    }
  ...
  class IntersectionMatrix {
    ...
    static matches() {
      if (Number.isInteger(arguments[0]) && typeof arguments[1] === 'string') {
        ...
        if (
          requiredDimensionSymbol === Dimension.SYM_TRUE &&
    ...
    isCovers() {
      const hasPointInCommon =
        IntersectionMatrix.isTrue(this._matrix[Location.INTERIOR][Location.INTERIOR]) ||
        IntersectionMatrix.isTrue(this._matrix[Location.INTERIOR][Location.BOUNDARY]) ||
        IntersectionMatrix.isTrue(this._matrix[Location.BOUNDARY][Location.INTERIOR]) ||
        IntersectionMatrix.isTrue(this._matrix[Location.BOUNDARY][Location.BOUNDARY])
      return (
        hasPointInCommon &&
        this._matrix[Location.EXTERIOR][Location.INTERIOR] === Dimension.FALSE &&
        this._matrix[Location.EXTERIOR][Location.BOUNDARY] === Dimension.FALSE
      )
    }
    ...
    isCoveredBy() {
      ...
      return (
        hasPointInCommon &&
        this._matrix[Location.INTERIOR][Location.EXTERIOR] === Dimension.FALSE &&
        this._matrix[Location.BOUNDARY][Location.EXTERIOR] === Dimension.FALSE
      )
    }
    ...
    isTouches(dimensionOfGeometryA, dimensionOfGeometryB) {
      ...
      if (
        ...
        return (
          this._matrix[Location.INTERIOR][Location.INTERIOR] === Dimension.FALSE &&
          (IntersectionMatrix.isTrue(this._matrix[Location.INTERIOR][Location.BOUNDARY]) ||
            IntersectionMatrix.isTrue(this._matrix[Location.BOUNDARY][Location.INTERIOR]) ||
            IntersectionMatrix.isTrue(this._matrix[Location.BOUNDARY][Location.BOUNDARY]))
        )
    ...
    isOverlaps(dimensionOfGeometryA, dimensionOfGeometryB) {
      if (
        (dimensionOfGeometryA === Dimension.P && dimensionOfGeometryB === Dimension.P) ||
        (dimensionOfGeometryA === Dimension.A && dimensionOfGeometryB === Dimension.A)
      )
        return (
          IntersectionMatrix.isTrue(this._matrix[Location.INTERIOR][Location.INTERIOR]) &&
          IntersectionMatrix.isTrue(this._matrix[Location.INTERIOR][Location.EXTERIOR]) &&
          IntersectionMatrix.isTrue(this._matrix[Location.EXTERIOR][Location.INTERIOR])
        )
      if (dimensionOfGeometryA === Dimension.L && dimensionOfGeometryB === Dimension.L)
        return (
          this._matrix[Location.INTERIOR][Location.INTERIOR] === 1 &&
          IntersectionMatrix.isTrue(this._matrix[Location.INTERIOR][Location.EXTERIOR]) &&
          IntersectionMatrix.isTrue(this._matrix[Location.EXTERIOR][Location.INTERIOR])
        )
      return false
    ...
    toString() {
      ...
      for (let ai = 0; ai < 3; ai++)
        for (let bi = 0; bi < 3; bi++) builder.setCharAt(3 * ai + bi, Dimension.toDimensionSymbol(this._matrix[ai][bi]))
    ...
    isDisjoint() {
      return (
        this._matrix[Location.INTERIOR][Location.INTERIOR] === Dimension.FALSE &&
        this._matrix[Location.INTERIOR][Location.BOUNDARY] === Dimension.FALSE &&
        this._matrix[Location.BOUNDARY][Location.INTERIOR] === Dimension.FALSE &&
        this._matrix[Location.BOUNDARY][Location.BOUNDARY] === Dimension.FALSE
      )
    }
    ...
    isCrosses(dimensionOfGeometryA, dimensionOfGeometryB) {
      ...
      if (
        (dimensionOfGeometryA === Dimension.L && dimensionOfGeometryB === Dimension.P) ||
  ...
  class AffineTransformation {
    ...
    isIdentity() {
      return (
        this._m00 === 1 && this._m01 === 0 && this._m02 === 0 && this._m10 === 0 && this._m11 === 1 && this._m12 === 0
      )
    }
    ...
    clone() {
      try {
        ...
        if (ex instanceof Exception) Assert.shouldNeverReachHere()
        else throw ex
      } finally {
      }
  ...
  class CoordinateOperation {
    edit(geometry, factory) {
      ...
      if (geometry instanceof LinearRing)
        if (coordinates === null) return factory.createLinearRing()
        else return factory.createLinearRing(coordinates)
      if (geometry instanceof LineString)
        if (coordinates === null) return factory.createLineString()
        else return factory.createLineString(coordinates)
      if (geometry instanceof Point)
        if (coordinates === null || coordinates.length === 0) return factory.createPoint()
        else return factory.createPoint(coordinates[0])
      return geometry
    }
  ...
  class GeometryExtracter {
    ...
    static isOfType(geom, geometryType) {
      ...
      if (geometryType === Geometry.TYPENAME_LINESTRING && geom.getGeometryType() === Geometry.TYPENAME_LINEARRING)
        return true
      return false
    }
    ...
    static extract() {
      if (arguments.length === 2) {
        ...
        const geom = arguments[0],
          geometryType = arguments[1],
          list = arguments[2]
        if (geom.getGeometryType() === geometryType) list.add(geom)
        else if (geom instanceof GeometryCollection) geom.apply(new GeometryExtracter(geometryType, list))
        return list
      }
    }
  ...
  class LineStringExtracter {
    ...
    static getLines() {
      if (arguments.length === 1) {
        ...
        else if (geom instanceof GeometryCollection) geom.apply(new LineStringExtracter(lines))
        return lines
      }
    }
  ...
  class LinearComponentExtracter {
    ...
    static getLines() {
      if (arguments.length === 1) {
        ...
        if (
          typeof arguments[2] === 'boolean' &&
          hasInterface(arguments[0], Collection) &&
          hasInterface(arguments[1], Collection)
        ) {
          const geoms = arguments[0],
            lines = arguments[1],
  ...
  class PointExtracter {
    ...
    static getPoints() {
      if (arguments.length === 1) {
        ...
        const geom = arguments[0],
          list = arguments[1]
        if (geom instanceof Point) list.add(geom)
        else if (geom instanceof GeometryCollection) geom.apply(new PointExtracter(list))
        return list
      }
    }
  ...
  class PolygonExtracter {
    ...
    static getPolygons() {
      if (arguments.length === 1) {
        ...
        const geom = arguments[0],
          list = arguments[1]
        if (geom instanceof Polygon) list.add(geom)
        else if (geom instanceof GeometryCollection) geom.apply(new PolygonExtracter(list))
        return list
      }
    }
  ...
  class GeometricShapeFactory {
    ...
    rotate(geom) {
      if (this._rotationAngle !== 0.0) {
        const trans = AffineTransformation.rotationInstance(
          this._rotationAngle,
  ...
  class DistanceToPoint {
    static computeDistance() {
      if (
        arguments[2] instanceof PointPairDistance &&
        arguments[0] instanceof LineString &&
        arguments[1] instanceof Coordinate
      ) {
        ...
        arguments[2] instanceof PointPairDistance &&
        arguments[0] instanceof Polygon &&
        arguments[1] instanceof Coordinate
      ) {
        ...
        arguments[2] instanceof PointPairDistance &&
        arguments[0] instanceof LineSegment &&
        arguments[1] instanceof Coordinate
      ) {
  ...
  class SortedPackedIntervalRTree {
    ...
    printNode(node) {
      System.out.println(
        WKTWriter.toLineString(new Coordinate(node._min, this._level), new Coordinate(node._max, this._level))
      )
    }
  ...
  class IndexedPointInAreaLocator {
    ...
    static constructor_() {
      ...
      this._index = null
      const g = arguments[0]
      if (!(hasInterface(g, Polygonal) || g instanceof LinearRing))
  ...
  class ConvexHull {
    ...
    cleanRing(original) {
      ...
      for (let i = 0; i <= original.length - 2; i++) {
        ...
        if (
          previousDistinctCoordinate !== null &&
  ...
  class PointLocator {
    ...
    locateOnLineString(p, l) {
      ...
      if (!l.isClosed())
        if (p.equals(seq.getCoordinate(0)) || p.equals(seq.getCoordinate(seq.size() - 1))) return Location.BOUNDARY
    ...
    locate(p, geom) {
      if (geom.isEmpty()) return Location.EXTERIOR
      if (geom instanceof LineString) return this.locateOnLineString(p, geom)
      else if (geom instanceof Polygon) return this.locateInPolygon(p, geom)
      this._isIn = false
      ...
      switch (this._extremalPts.length) {
        ...
        case 2:
          this._centre = new Coordinate(
            (this._extremalPts[0].x + this._extremalPts[1].x) / 2.0,
            (this._extremalPts[0].y + this._extremalPts[1].y) / 2.0
          )
          break
  ...
  class MinimumDiameter {
    ...
    computeWidthConvex(convexGeom) {
      if (convexGeom instanceof Polygon) this._convexHullPts = convexGeom.getExteriorRing().getCoordinates()
      else this._convexHullPts = convexGeom.getCoordinates()
  ...
  class EdgeGraph {
    ...
    insert(orig, dest, eAdj) {
      ...
      if (eAdj !== null) eAdj.insert(e)
      else this._vertexMap.put(orig, e)

      const eAdjDest = this._vertexMap.get(dest)

      if (eAdjDest !== null) eAdjDest.insert(e.sym())
      else this._vertexMap.put(dest, e.sym())
      return e
    }
  ...
  class SimpleMCSweepLineIntersector extends EdgeSetIntersector {
    ...
    computeIntersections() {
      if (arguments.length === 1) {
        ...
        if (
          arguments[2] instanceof SegmentIntersector$1 &&
          hasInterface(arguments[0], List) &&
          ...
          typeof arguments[2] === 'boolean' &&
          hasInterface(arguments[0], List) &&
          arguments[1] instanceof SegmentIntersector$1
        ) {
  ...
  class Label {
    ...
    merge(lbl) {
      for (let i = 0; i < 2; i++)
        if (this.elt[i] === null && lbl.elt[i] !== null) this.elt[i] = new TopologyLocation(lbl.elt[i])
  ...
  class MonotoneChainEdge {
    ...
    computeIntersectsForChain() {
      if (arguments.length === 4) {
        ...
        this.computeIntersectsForChain(
          this.startIndex[chainIndex0],
          this.startIndex[chainIndex0 + 1],
          mce,
    ...
    computeIntersects(mce, si) {
      for (let i = 0; i < this.startIndex.length - 1; i++)
        for (let j = 0; j < mce.startIndex.length - 1; j++) this.computeIntersectsForChain(i, mce, j, si)
    }
  }
  ...
  class Node$2 extends GraphComponent$1 {
    ...
    setLabel() {
      if (arguments.length === 2 && Number.isInteger(arguments[1]) && Number.isInteger(arguments[0])) {
        ...
        if (this._label === null) this._label = new Label(argIndex, onLocation)
  ...
  class EdgeEnd {
    ...
    print(out) {
      ...
      out.print(
        '  ' + name + ': ' + this._p0 + ' - ' + this._p1 + ' ' + this._quadrant + ':' + angle + '   ' + this._label
      )
    }
  ...
  class PlanarGraph$1 {
    ...
    matchInSameDirection(p0, p1, ep0, ep1) {
      ...
      if (
        Orientation.index(p0, p1, ep1) === Orientation.COLLINEAR &&
  ...
  class GeometryGraph extends PlanarGraph$1 {
    ...
    computeSelfNodes() {
      if (arguments.length === 2) {
        ...
        const isRings =
          this._parentGeom instanceof LinearRing ||
          this._parentGeom instanceof Polygon ||
          this._parentGeom instanceof MultiPolygon
    ...
    addSelfIntersectionNode(argIndex, coord, loc) {
      ...
      if (loc === Location.BOUNDARY && this._useBoundaryDeterminationRule) this.insertBoundaryPoint(argIndex, coord)
    ...
    insertPoint(argIndex, coord, onLocation) {
      ...
      const lbl = n.getLabel()
      if (lbl === null) n._label = new Label(argIndex, onLocation)
  ...
  class KdTree {
    ...
    insertExact(p, data) {
      ...
      while (currentNode !== null) {
        ...
        if (isOddLevel) isLessThan = p.x < currentNode.getX()
        else isLessThan = p.y < currentNode.getY()
        leafNode = currentNode
        if (isLessThan) currentNode = currentNode.getLeft()
      ...
      if (isLessThan) leafNode.setLeft(node)
      else leafNode.setRight(node)
      return node
    }
  }
  ...
  class BestMatchVisitor {
    ...
    visit(node) {
      ...
      if (
        this._matchNode === null ||
        dist < this._matchDist ||
        (this._matchNode !== null &&
          dist === this._matchDist &&
          node.getCoordinate().compareTo(this._matchNode.getCoordinate()) < 1)
      )
        update = true
  ...
  class NodeBase {
    ...
    addAllItemsFromOverlapping(searchEnv, resultItems) {
      ...
      for (let i = 0; i < 4; i++)
        if (this._subnode[i] !== null) this._subnode[i].addAllItemsFromOverlapping(searchEnv, resultItems)
    }
  ...
  class PriorityQueue {
    ...
    reorder(hole) {
      ...
      for (; hole * 2 <= this._size; hole = child) {
        ...
        if (this._items.get(child).compareTo(tmp) < 0) this._items.set(hole, this._items.get(child))
        else break
      }
  ...
  class AbstractSTRtree {
    ...
    queryInternal() {
      if (
        hasInterface(arguments[2], ItemVisitor) &&
        arguments[0] instanceof Object &&
        arguments[1] instanceof AbstractNode
      ) {
        ...
        for (let i = 0; i < childBoundables.size(); i++) {
          ...
          if (childBoundable instanceof AbstractNode) this.queryInternal(searchBounds, childBoundable, visitor)
          else if (childBoundable instanceof ItemBoundable) visitor.visitItem(childBoundable.getItem())
          else Assert.shouldNeverReachHere()
        }
      } else if (
        hasInterface(arguments[2], List) &&
        arguments[0] instanceof Object &&
        arguments[1] instanceof AbstractNode
      ) {
        const searchBounds = arguments[0],
        ...
        for (let i = 0; i < childBoundables.size(); i++) {
          const childBoundable = childBoundables.get(i)
          if (!this.getIntersectsOp().intersects(childBoundable.getBounds(), searchBounds)) continue
          if (childBoundable instanceof AbstractNode) this.queryInternal(searchBounds, childBoundable, matches)
          else if (childBoundable instanceof ItemBoundable) matches.add(childBoundable.getItem())
          else Assert.shouldNeverReachHere()
        }
      }
    }
    ...
    size() {
      if (arguments.length === 0) {
        ...
        for (let i = node.getChildBoundables().iterator(); i.hasNext(); ) {
          ...
          if (childBoundable instanceof AbstractNode) size += this.size(childBoundable)
          else if (childBoundable instanceof ItemBoundable) size += 1
        }
  ...
  class STRtreeNode extends AbstractNode {
    ...
    computeBounds() {
      ...
      for (let i = this.getChildBoundables().iterator(); i.hasNext(); ) {
        const childBoundable = i.next()
        if (bounds === null) bounds = new Envelope(childBoundable.getBounds())
  ...
  class GeoJSONParser {
    ...
    read(json) {
      ...
      if (geometryTypes.indexOf(type) !== -1) return parse[type].call(this, obj.coordinates)
      else if (type === 'GeometryCollection') return parse[type].call(this, obj.geometries) // feature or feature collection
  ...
  class OL3Parser {
    ...
    read(geometry) {
      const ol = this.ol
      if (geometry instanceof ol.geom.Point) return this.convertFromPoint(geometry)
      else if (geometry instanceof ol.geom.LineString) return this.convertFromLineString(geometry)
      else if (geometry instanceof ol.geom.LinearRing) return this.convertFromLinearRing(geometry)
      else if (geometry instanceof ol.geom.Polygon) return this.convertFromPolygon(geometry)
      else if (geometry instanceof ol.geom.MultiPoint) return this.convertFromMultiPoint(geometry)
      else if (geometry instanceof ol.geom.MultiLineString) return this.convertFromMultiLineString(geometry)
      else if (geometry instanceof ol.geom.MultiPolygon) return this.convertFromMultiPolygon(geometry)
    ...
    convertFromLineString(lineString) {
      return this.geometryFactory.createLineString(
        lineString.getCoordinates().map(function (coordinates) {
    ...
    convertFromLinearRing(linearRing) {
      return this.geometryFactory.createLinearRing(
        linearRing.getCoordinates().map(function (coordinates) {
          return new Coordinate(coordinates[0], coordinates[1])
        })
      )
    }
      ...
      if (hasInterface(arguments[0], Collection)) {
        ...
        for (let i = 0; i < pts.length; i++)
          roundPts[i] = new Coordinate(
            Math.round((pts[i].x - this._offsetX) * this._scaleFactor),
            Math.round((pts[i].y - this._offsetY) * this._scaleFactor),
            pts[i].getZ()
          )
  ...
  class BoundaryOp {
    ...
    boundaryLineString(line) {
      ...
      if (line.isClosed()) {
        ...
        else return this._geomFact.createMultiPoint()
      }
  ...
  class RightmostEdgeFinder {
    ...
    findEdge(dirEdgeList) {
      ...
      Assert.isTrue(
        this._minIndex !== 0 || this._minCoord.equals(this._minDe.getCoordinate()),
  ...
  class OffsetSegmentGenerator {
    ...
    addNextSegment(p, addStartPoint) {
      ...
      const outsideTurn =
        (orientation === Orientation.CLOCKWISE && this._side === Position.LEFT) ||
        (orientation === Orientation.COUNTERCLOCKWISE && this._side === Position.RIGHT)
    ...
    addLineEndCap(p0, p1) {
      ...
      switch (this._bufParams.getEndCapStyle()) {
        ...
        case BufferParameters.CAP_SQUARE:
          ...
          const squareCapLOffset = new Coordinate(
            offsetL.p1.x + squareCapSideOffset.x,
            offsetL.p1.y + squareCapSideOffset.y
          )
          const squareCapROffset = new Coordinate(
      ...
      if (this._li.hasIntersection()) {
        ...
        if (
          ...
          if (this._closingSegLengthFactor > 0) {
            const mid0 = new Coordinate(
              (this._closingSegLengthFactor * this._offset0.p1.x + this._s1.x) / (this._closingSegLengthFactor + 1),
              (this._closingSegLengthFactor * this._offset0.p1.y + this._s1.y) / (this._closingSegLengthFactor + 1)
            )

            this._segList.addPt(mid0)

            const mid1 = new Coordinate(
              (this._closingSegLengthFactor * this._offset1.p0.x + this._s1.x) / (this._closingSegLengthFactor + 1),
              (this._closingSegLengthFactor * this._offset1.p0.y + this._s1.y) / (this._closingSegLengthFactor + 1)
            )
    ...
    addCollinear(addStartPoint) {
      ...
      if (numInt >= 2)
        if (
          this._bufParams.getJoinStyle() === BufferParameters.JOIN_BEVEL ||
          this._bufParams.getJoinStyle() === BufferParameters.JOIN_MITRE
        ) {
          if (addStartPoint) this._segList.addPt(this._offset0.p1)
  ...
  class SubgraphDepthLocater {
    ...
    findStabbedSegments() {
      if (arguments.length === 1) {
        ...
        if (
          hasInterface(arguments[2], List) &&
          arguments[0] instanceof Coordinate &&
          arguments[1] instanceof DirectedEdge$1
        ) {
          const stabbingRayLeftPt = arguments[0],
            dirEdge = arguments[1],
    ...
    checkInteriorIntersections() {
      if (arguments.length === 0) {
        ...
        for (let i0 = 0; i0 < pts0.length - 1; i0++)
          for (let i1 = 0; i1 < pts1.length - 1; i1++) this.checkInteriorIntersections(ss0, i0, ss1, i1)
      } else if (arguments.length === 4) {
        ...
        if (this._li.hasIntersection())
          if (
            this._li.isProper() ||
            this.hasInteriorIntersection(this._li, p00, p01) ||
            this.hasInteriorIntersection(this._li, p10, p11)
          )
  ...
  class HotPixel {
    ...
    intersectsScaled(p0, p1) {
      ...
      const isOutsidePixelEnv =
        this._maxx < segMinx || this._minx > segMaxx || this._maxy < segMiny || this._miny > segMaxy
    ...
    getSafeEnvelope() {
      if (this._safeEnv === null) {
        ...
        this._safeEnv = new Envelope(
          this._originalPt.x - safeTolerance,
          this._originalPt.x + safeTolerance,
          this._originalPt.y - safeTolerance,
          this._originalPt.y + safeTolerance
        )
      }
  ...
  class MCIndexSnapRounder {
    ...
    checkCorrectness(inputSegmentStrings) {
      ...
      try {
        ...
        if (ex instanceof Exception) ex.printStackTrace()
        else throw ex
      } finally {
      }
    }
  ...
  class BufferOp {
    ...
    static bufferOp() {
      if (arguments.length === 2) {
        ...
        if (Number.isInteger(arguments[2]) && arguments[0] instanceof Geometry && typeof arguments[1] === 'number') {
          ...
          arguments[2] instanceof BufferParameters &&
          arguments[0] instanceof Geometry &&
          typeof arguments[1] === 'number'
        ) {
          const g = arguments[0],
      ...
      if (arguments.length === 0) {
        for (let precDigits = BufferOp.MAX_PRECISION_DIGITS; precDigits >= 0; precDigits--) {
          try {
            ...
            if (ex instanceof TopologyException) this._saveException = ex
            else throw ex
          } finally {
          }
    ...
    computeGeometry() {
      ...
      if (argPM.getType() === PrecisionModel.FIXED) this.bufferFixedPrecision(argPM)
    ...
    bufferOriginalPrecision() {
      try {
        ...
        if (ex instanceof RuntimeException) this._saveException = ex
        else throw ex
      } finally {
      }
    }
    ...
    computeContainmentDistance() {
      if (arguments.length === 0) {
        ...
        if (arguments[2] instanceof Array && hasInterface(arguments[0], List) && hasInterface(arguments[1], List)) {
          ...
          arguments[0] instanceof GeometryLocation &&
          arguments[1] instanceof Polygon
        ) {
    ...
    computeMinDistance() {
      if (arguments.length === 0) {
        ...
        if (arguments[2] instanceof Array && arguments[0] instanceof LineString && arguments[1] instanceof Point) {
          ...
          arguments[2] instanceof Array &&
          arguments[0] instanceof LineString &&
          arguments[1] instanceof LineString
        ) {
  ...
  class LineSequencer {
    ...
    computeSequence() {
      ...
      Assert.isTrue(
        this._sequencedGeometry instanceof LineString || this._sequencedGeometry instanceof MultiLineString,
    ...
    static computeOverlaySnapTolerance() {
      if (arguments.length === 1) {
        ...
        const g0 = arguments[0],
          g1 = arguments[1]
        return Math.min(
          GeometrySnapper.computeOverlaySnapTolerance(g0),
          GeometrySnapper.computeOverlaySnapTolerance(g1)
        )
      }
    }
  ...
  class NodingIntersectionFinder {
    ...
    processIntersections(e0, segIndex0, e1, segIndex1) {
      ...
      if (this._isCheckEndSegmentsOnly) {
        const isEndSegPresent =
          NodingIntersectionFinder.isEndSegment(e0, segIndex0) || NodingIntersectionFinder.isEndSegment(e1, segIndex1)
      ...
      if (!this._isInteriorIntersectionsOnly) {
        ...
        isInteriorVertexInt =
          !isAdjacentSegment &&
          NodingIntersectionFinder.isInteriorVertexIntersection(p00, p01, p10, p11, isEnd00, isEnd01, isEnd10, isEnd11)
      }
  ...
  class CommonBits {
    ...
    toString() {
      if (arguments.length === 1) {
        ...
        const str =
          bitStr.substring(0, 1) + '  ' + bitStr.substring(1, 12) + '(exp) ' + bitStr.substring(12) + ' [ ' + x + ' ]'
        return str
      }
    }
  ...
  class SnapIfNeededOverlayOp {
    ...
    getResultGeometry(opCode) {
      ...
      try {
        ...
        if (ex instanceof RuntimeException) savedException = ex
        else throw ex
      } finally {
      }
      ...
      if (!isSuccess)
        try {
          ...
          if (ex instanceof RuntimeException) throw savedException
          else throw ex
        } finally {
        }
      return result
    ...
    findResultAreaEdges(opCode) {
      for (let it = this._graph.getEdgeEnds().iterator(); it.hasNext(); ) {
        ...
        if (
          ...
          OverlayOp.isResultOfOp(label.getLocation(0, Position.RIGHT), label.getLocation(1, Position.RIGHT), opCode)
        )
          de.setInResult(true)
      }
    }
  ...
  class EdgeEndBundle extends EdgeEnd {
    ...
    computeLabel(boundaryNodeRule) {
      ...
      if (isArea) this._label = new Label(Location.NONE, Location.NONE, Location.NONE)
      else this._label = new Label(Location.NONE)
  ...
  TopologyValidationError.errMsg = [
  ...
  class IsValidOp {
    ...
    checkHolesNotNested(p, graph) {
      ...
      if (!isNonNested)
        this._validErr = new TopologyValidationError(
    ...
    checkConnectedInteriors(graph) {
      ...
      if (!cit.isInteriorsConnected())
        this._validErr = new TopologyValidationError(TopologyValidationError.DISCONNECTED_INTERIOR, cit.getCoordinate())
    }
  ...
  class EdgeRing {
    ...
    static addEdge(coords, isForward, coordList) {
      if (isForward) for (let i = 0; i < coords.length; i++) coordList.add(coords[i], false)
      else for (let i = coords.length - 1; i >= 0; i--) coordList.add(coords[i], false)
    }
    ...
    getRing() {
      ...
      try {
        ...
        if (ex instanceof Exception) System.out.println(this._ringPts)
        else throw ex
      } finally {
      }
  ...
  class Polygonizer {
    ...
    findValidRings(edgeRingList, validEdgeRingList, invalidRingList) {
      for (let i = edgeRingList.iterator(); i.hasNext(); ) {
        ...
        else invalidRingList.add(er.getLineString())
      }
    }
    ...
    polygonize() {
      ...
      this._invalidRingLines = new ArrayList()
      if (this._isCheckingRingsValid) this.findValidRings(edgeRingList, validEdgeRingList, this._invalidRingLines)
    ...
    findShellsAndHoles(edgeRingList) {
      ...
      for (let i = edgeRingList.iterator(); i.hasNext(); ) {
        const er = i.next()
        er.computeHole()
        if (er.isHole()) this._holeList.add(er)
        else this._shellList.add(er)
      }
    }
  }
  ...
  class RelateComputer {
    ...
    computeIM() {
      ...
      if (
        !this._arg[0].getGeometry().getEnvelopeInternal().intersects(this._arg[1].getGeometry().getEnvelopeInternal())
      ) {
  ...
  class RectangleContains {
    ...
    isPointContainedInBoundary() {
      if (arguments[0] instanceof Point) {
        ...
        const pt = arguments[0]
        return (
          pt.x === this._rectEnv.getMinX() ||
          pt.x === this._rectEnv.getMaxX() ||
          pt.y === this._rectEnv.getMinY() ||
          pt.y === this._rectEnv.getMaxY()
        )
      }
    }
      ...
      if (g1.isGeometryCollection() || g2.isGeometryCollection()) {
        for (let i = 0; i < g1.getNumGeometries(); i++)
          for (let j = 0; j < g2.getNumGeometries(); j++)
            if (g1.getGeometryN(i).intersects(g2.getGeometryN(j))) return true
  ...
  class OverlapUnion {
    ...
    unionFull(geom0, geom1) {
      try {
        ...
        if (ex instanceof TopologyException) return OverlapUnion.unionBuffer(geom0, geom1)
        else throw ex
      } finally {
      }
    }
  ...
  class CascadedPolygonUnion {
    ...
    reduceToGeometries(geomTree) {
      ...
      for (let i = geomTree.iterator(); i.hasNext(); ) {
        const o = i.next()
        let geom = null
        if (hasInterface(o, List)) geom = this.unionTree(o)
        else if (o instanceof Geometry) geom = o
        geoms.add(geom)
      }
      ...
      if (arguments.length === 1) {
        ...
        if (end - start <= 1) {
          ...
          return this.unionSafe(
            CascadedPolygonUnion.getGeometry(geoms, start),
  ...
  class UnaryUnionOp {
    ...
    union() {
      ...
      else union = PointGeometryUnion.union(unionPoints, unionLA)
  ...
  class EnhancedPrecisionOp {
    static union(geom0, geom1) {
      ...
      try {
        ...
        if (ex instanceof RuntimeException) originalEx = ex
        else throw ex
      } finally {
      }
      ...
      try {
        ...
        if (ex2 instanceof RuntimeException) throw originalEx
        else throw ex2
      } finally {
      }
    }
  ...
  class GeometryPrecisionReducer {
    ...
    reducePointwise(geom) {
      ...
      const reduceGeom = geomEdit.edit(
        geom,
        new PrecisionReducerCoordinateOperation(this._targetPM, finalRemoveCollapsed)
      )
      return reduceGeom
    }
  ...
  class DPTransformer extends GeometryTransformer {
    ...
    transformCoordinates(coords, parent) {
      const inputPts = coords.toCoordinateArray()
      let newPts = null
      if (inputPts.length === 0) newPts = new Array(0).fill(null)
      else newPts = DouglasPeuckerLineSimplifier.simplify(inputPts, this._distanceTolerance)
      return this._factory.getCoordinateSequenceFactory().create(newPts)
    }
  ...
  class VWLineSimplifier {
    ...
    simplify() {
      ...
      do minArea = this.simplifyVertex(vwLine)
  ...
  class VWTransformer extends GeometryTransformer {
    ...
    transformCoordinates(coords, parent) {
      ...
      let newPts = null
      if (inputPts.length === 0) newPts = new Array(0).fill(null)
      else newPts = VWLineSimplifier.simplify(inputPts, this._distanceTolerance)
      return this._factory.getCoordinateSequenceFactory().create(newPts)
    }
  ...
  class SplitSegment {
    ...
    splitAt() {
      if (arguments.length === 1) {
        ...
        if (endPt.equals2D(this._seg.p0)) this._splitPt = this._seg.pointAlong(frac)
        else this._splitPt = SplitSegment.pointAlongReverse(this._seg, frac)
      }
    }
  ...
  class TrianglePredicate {
    ...
    static checkRobustInCircle(a, b, c, p) {
      ...
      System.out.println(
        'p radius diff a = ' + Math.abs(p.distance(circumCentre) - a.distance(circumCentre)) / a.distance(circumCentre)
      )
    ...
    static isInCircleDDSlow(a, b, c, p) {
      ...
      const aTerm = ax
        .multiply(ax)
        .add(ay.multiply(ay))
        .multiply(TrianglePredicate.triAreaDDSlow(bx, by, cx, cy, px, py))
      const bTerm = bx
        .multiply(bx)
        .add(by.multiply(by))
        .multiply(TrianglePredicate.triAreaDDSlow(ax, ay, cx, cy, px, py))
      const cTerm = cx
        .multiply(cx)
        .add(cy.multiply(cy))
        .multiply(TrianglePredicate.triAreaDDSlow(ax, ay, bx, by, px, py))
      const pTerm = px
        .multiply(px)
        .add(py.multiply(py))
        .multiply(TrianglePredicate.triAreaDDSlow(ax, ay, bx, by, cx, cy))
    ...
    static isInCircleNonRobust(a, b, c, p) {
      const isInCircle =
        (a.x * a.x + a.y * a.y) * TrianglePredicate.triArea(b, c, p) -
          (b.x * b.x + b.y * b.y) * TrianglePredicate.triArea(a, c, p) +
          (c.x * c.x + c.y * c.y) * TrianglePredicate.triArea(a, b, p) -
          (p.x * p.x + p.y * p.y) * TrianglePredicate.triArea(a, b, c) >
        0
      return isInCircle
    }
  ...
  class Vertex {
    ...
    equals() {
      if (arguments.length === 1) {
        const _x = arguments[0]
        if (this._p.x === _x.getX() && this._p.y === _x.getY()) return true
        else return false
      } else if (arguments.length === 2) {
        const _x = arguments[0],
          tolerance = arguments[1]
        if (this._p.distance(_x.getCoordinate()) < tolerance) return true
        else return false
      }
    }
  ...
  class QuadEdge {
    ...
    equalsOriented(qe) {
      if (
        this.orig().getCoordinate().equals2D(qe.orig().getCoordinate()) &&
    ...
    getPrimary() {
      if (this.orig().getCoordinate().compareTo(this.dest().getCoordinate()) <= 0) return this
    ...
    static constructor_() {
      ...
      if (arguments.length === 1) {
        if (typeof arguments[0] === 'string') {
          ...
          const seg = arguments[0]
          RuntimeException.constructor_.call(
            this,
  ...
  class QuadEdgeSubdivision {
    ...
    createFrame(env) {
      ...
      let offset = 0.0
      if (deltaX > deltaY) offset = deltaX * 10.0
      else offset = deltaY * 10.0
    ...
    locateFromEdge(v, startEdge) {
      ...
      while (true) {
        ...
        else if (v.rightOf(e)) e = e.sym()
        else if (!v.rightOf(e.oNext())) e = e.oNext()
        else if (!v.rightOf(e.dPrev())) e = e.dPrev()
        else break
      }
  ...
  class TriangleCoordinatesVisitor {
    ...
    checkTriangleSize(pts) {
      if (pts.length >= 2) WKTWriter.toLineString(pts[0], pts[1])
      else if (pts.length >= 1) WKTWriter.toPoint(pts[0])
    }
  ...
  class ConformingDelaunayTriangulator {
    ...
    createVertex() {
      if (arguments.length === 1) {
        const p = arguments[0]
        let v = null
        if (this._vertexFactory !== null) v = this._vertexFactory.createVertex(p, null)
        ...
        const p = arguments[0],
          seg = arguments[1]
        let v = null
        if (this._vertexFactory !== null) v = this._vertexFactory.createVertex(p, seg)
        else v = new ConstraintVertex(p)
  ...
  class LinearIterator {
    ...
    static constructor_() {
      ...
      if (arguments.length === 1) {
        ...
        const linear = arguments[0],
          start = arguments[1]
        LinearIterator.constructor_.call(
          this,
          linear,
          start.getComponentIndex(),
          LinearIterator.segmentEndVertexIndex(start)
        )
      } else if (arguments.length === 3) {
    ...
    getSegmentEnd() {
      if (this._vertexIndex < this.getLine().getNumPoints() - 1)
    ...
    hasNext() {
      if (this._componentIndex >= this._numLines) return false
      if (this._componentIndex === this._numLines - 1 && this._vertexIndex >= this._currentLine.getNumPoints())
        return false
      return true
    }
  }
  ...
  class LinearLocation {
    ...
    snapToVertex(linearGeom, minDistance) {
      ...
      if (lenToStart <= lenToEnd && lenToStart < minDistance) this._segmentFraction = 0.0
      else if (lenToEnd <= lenToStart && lenToEnd < minDistance) this._segmentFraction = 1.0
    }
  ...
  class LocationIndexOfLine {
    ...
    indicesOf(subLine) {
      ...
      if (subLine.getLength() === 0.0) subLineLoc[1] = subLineLoc[0].copy()
  ...
  class LengthLocationMap {
    ...
    resolveHigher(loc) {
      ...
      do compIndex++
      while (
        compIndex < this._linearGeom.getNumGeometries() - 1 &&
        this._linearGeom.getGeometryN(compIndex).getLength() === 0
      )
  ...
  class LengthIndexedLine {
    ...
    indicesOf(subLine) {
      ...
      const index = [
        LengthLocationMap.getLength(this._linearGeom, locIndex[0]),
        LengthLocationMap.getLength(this._linearGeom, locIndex[1])
      ]
      return index
    }
  }
  ...
  class ObjectCounter {
    ...
    add(o) {
      ...
      if (counter === null) this._counts.put(o, new Counter(1))
      ...
      if (arguments.length === 1) {
        ...
        for (let i = 0; i < depth; i++)
          try {
            ...
            if (e instanceof IOException) Assert.shouldNeverReachHere()
            else throw e
          } finally {
          }
